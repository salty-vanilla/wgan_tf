...
class ImageSampler:
    def __init__(self, image_dir,
                 is_flip=True, target_size=None,
                 color_mode='rgb', normalize_mode='tanh', nb_sample=None):
...
class DataIterator(Iterator):
    def __init__(self, paths, is_flip, target_size, color_mode, batch_size, normalize_mode, shuffle, seed):
        self.paths = paths
        self.is_flip = is_flip
        self.target_size = target_size
        self.color_mode = color_mode
