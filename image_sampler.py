...
class ImageSampler:
    def __init__(self, image_dir, target_size=None, color_mode='rgb', normalize_mode='tanh', nb_sample=None):
    ...
    def flow(self, batch_size, shuffle=True, seed=None):
...
class DataIterator(Iterator):
    def __init__(self, paths, target_size, color_mode, batch_size, normalize_mode, shuffle, seed):
        self.paths = paths
        self.target_size = target_size
        self.color_mode = color_mode
